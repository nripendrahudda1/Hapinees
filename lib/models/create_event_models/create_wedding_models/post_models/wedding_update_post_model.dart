...
WeddingUpdatePostModel weddingUpdatePostModelFromJson(String str) => WeddingUpdatePostModel.fromJson(json.decode(str));

String weddingUpdatePostModelToJson(WeddingUpdatePostModel data) => json.encode(data.toJson());

class WeddingUpdatePostModel {
  int? weddingHeaderId;
  ...
  factory WeddingUpdatePostModel.fromJson(Map<String, dynamic> json) => WeddingUpdatePostModel(
