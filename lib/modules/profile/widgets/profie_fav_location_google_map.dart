...
class ProfileFavLocationMap extends ConsumerStatefulWidget {
  const ProfileFavLocationMap({super.key, required this.stories});
  final List<Stories> stories;
  @override
  ConsumerState<ProfileFavLocationMap> createState() => MapScreenState();
}

class MapScreenState extends ConsumerState<ProfileFavLocationMap> {
      ...
      _markers.add(
        Marker(
          ...
          onTap: () {
            ...
            _.animateToFavLocationPage(index);
            _.notifyListeners();
          },
        ),
      );
  ...
  Widget build(BuildContext context) {
    ...
    if (isMarkerGenerated) {
      if (dayID != _.currFavLocationPage && haveMarkers[_.currFavLocationPage]) {
        Stories data = widget.stories[_.currFavLocationPage];
