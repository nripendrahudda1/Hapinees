...
class ProfileMap extends ConsumerStatefulWidget {
  const ProfileMap({super.key, required this.stories});
  final List<Stories> stories;
  @override
  ConsumerState<ProfileMap> createState() => MapScreenState();
}

class MapScreenState extends ConsumerState<ProfileMap> {
  ...
  Widget build(BuildContext context) {
    ...
    if (isMarkerGenerated) {
      if (dayID != _.userProCurrPage && haveMarkers[_.userProCurrPage]) {
        Stories data = widget.stories[_.userProCurrPage];
        int index =
