...
class UpdateInfoUploadAudioWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UpdateInfoUploadAudioWidget> createState() =>
      _ChoseWeddingStyleWidgetState();
}

class _ChoseWeddingStyleWidgetState
    extends ConsumerState<UpdateInfoUploadAudioWidget> {
  String? audioPath;

  @override
  void initState() {
    audioPath = widget.audioFileLink;
    init();
    super.initState();
  }
  ...
  init() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ref.watch(updateEventMoreInfoExpandedCtr).setBgMusicUnExpanded();
  });
  }
  ...
  void _toggleExpansion() {
    if (ref.watch(updateEventMoreInfoExpandedCtr).bgMusicExpanded) {
      ref.watch(updateEventMoreInfoExpandedCtr).setBgMusicUnExpanded();
    } else {
      ref.watch(updateEventMoreInfoExpandedCtr).setBgMusicExpanded();
    }
  }
      ...
      children: [
        Container(
          decoration: BoxDecoration(
              ...
              boxShadow: [
                ref.watch(updateEventMoreInfoExpandedCtr).bgMusicExpanded
                    ? BoxShadow(
