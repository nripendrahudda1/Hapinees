...
final updateEventExpandedCtr = ChangeNotifierProvider((ref) => UpdateEventExpandedController());

class UpdateEventExpandedController extends ChangeNotifier {
  // bool _occasionExpanded = false;
  ...
  setWeddingStyleExpanded() {
    ...
    _datesExpanded = false;
    _guestVisibilityExpanded = false;
    _personalEventThemeExpanded = false;
  ...
  bool _personalEventThemeExpanded = false;
  bool get personalEventThemeExpanded => _personalEventThemeExpanded;
  setPersonalEventThemeExpanded() {
    // _occasionExpanded = false;
    _personalEventThemeExpanded = true;
    _weddingStyleExpanded = false;
    _ritualsExpanded = false;
    _coupleExpanded = false;
    _titleExpanded = false;
  ...
  setPersonalEventThemeUnExpanded() {
    // _occasionExpanded = false;
    _personalEventThemeExpanded = false;
    _weddingStyleExpanded = false;
    _ritualsExpanded = false;
