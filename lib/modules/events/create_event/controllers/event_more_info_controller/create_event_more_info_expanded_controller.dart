...
final createEventMoreInfoExpandedCtr =
    ChangeNotifierProvider((ref) => CreateEventMoreInfoExpandedController());

class CreateEventMoreInfoExpandedController extends ChangeNotifier {
