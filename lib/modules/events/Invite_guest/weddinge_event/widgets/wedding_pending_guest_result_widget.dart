...
class WeddingPendingGuestResultWidget extends StatefulWidget {
  const WeddingPendingGuestResultWidget(
      {super.key,
  ...
  @override
  State<WeddingPendingGuestResultWidget> createState() =>
      _WeddingPendingGuestResultWidgetState();
}

class _WeddingPendingGuestResultWidgetState extends State<WeddingPendingGuestResultWidget> {
